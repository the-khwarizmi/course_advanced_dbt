...
- Columns that have been tested in the Source should not be retested.
- Derived columns that contain category values must have an accepted_values schema test.
- Derived columns that should never be null must have a not_null schema test.
- Derived columns that should be unique must have a unique schema test.
